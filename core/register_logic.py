...
"""
RegisterWindow — вікно реєстрації LGE (Patch 14.2, глобальний LANG)

Функції:
    • вибір мови інтерфейсу (оновлює LANG)
    • введення e-mail і паролів
    • валідація
    • шифрування AES та створення LGE.conf
...
from core.common_dialogs import CommonErrorDialog, CommonInfoDialog
...
class RegisterWindow(QMainWindow):
    """Вікно реєстрації користувача LGE."""
    ...
    def _do_register(self) -> None:
        ...
        try:
            ...
            CommonInfoDialog.show_dialog(
                ...
                self._lang_mgr,
                title=title,
                header=msg.splitlines()[0] if msg.splitlines() else title,
            ...
            CommonErrorDialog.show_dialog(
                ...
                header="Failed to create config",
                details=f"{ex!r}",
            )
