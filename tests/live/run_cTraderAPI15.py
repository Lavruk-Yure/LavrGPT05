...
from core.token_manager import get_tokens_path, refresh_if_needed, save_tokens
...
def get_access_token():
    ...
    if tokens:
        ...
        print(
            ...
            f"Потрібно пройти авторизацію через Selenium. Файл: {get_tokens_path()}"
        )
        return None
...
def main():
    ...
    if token_data:  # noqa
        ...
        print(f"[token_manager] Save path: {get_tokens_path()}")
        save_tokens(
            {
