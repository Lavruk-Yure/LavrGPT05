# run_backtester_live_compact_realtime.py
"""
run_backtester_live_compact_realtime.py

Скрипт для запуску бек-тесту з SMA-стратегією та live компактним монітором
у режимі реального часу.
Виводить інформацію про торги та фінальний баланс.
"""
