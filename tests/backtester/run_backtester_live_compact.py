# run_backtester_live_compact.py
"""
run_backtester_live_compact.py

Скрипт для запуску бек-тесту з SMA-стратегією у режимі live compact монітора.
Виконує тестування з даними data/data.csv,
виводить інформацію про відкриття/закриття угод і фінальний баланс.
"""
