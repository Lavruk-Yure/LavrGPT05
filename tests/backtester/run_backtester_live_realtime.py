# run_backtester_live_realtime.py
"""
run_backtester_live_realtime.py

Скрипт для запуску бек-тесту зі SMA стратегією та монітором у режимі реального часу.
Виконує торгівлю по історичних даних, виводить угоди та фінальний баланс.
"""
...
def main():
    ...
    # Закриття усіх відкритих ордерів в кінці
    for order in open_orders:
