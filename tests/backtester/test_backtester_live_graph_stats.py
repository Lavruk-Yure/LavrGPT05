...
Тест бек-тестера з SMA стратегією та статистичним графічним монітором.
Перевіряє обробку відкритих та закритих ордерів і оновлення монітора.
"""
...
def backtester_setup():
    """
    Ініціалізація RiskManager, SMA стратегії, Backtester і LiveMonitorGraphStats.
    """
...
def test_live_graph_stats_backtester(backtester_setup):
    """
    Імітує торгівлю з відкритими та закритими ордерами,
    оновлює статистичний графічний монітор,
    перевіряє базові властивості фінального балансу.
    """
    ...
    for i, candle in enumerate(data):
        ...
        # Додаємо поле profit, якщо бракує
