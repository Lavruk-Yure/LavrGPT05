...
FIRST_UNRESOLVED_BOUNDARY = "AUTHORITATIVE_BROKER_ACCOUNT_DAY_PERIOD_IDENTITY"
BOUNDARY_CONTRACT = (
...
IB_DOCUMENTED_RESET_SOURCE = (
    "TWS_GLOBAL_CONFIGURATION_PNL_RESET_SCHEDULE_" "INSTRUMENT_SPECIFIC_BY_DEFAULT"
)
PRODUCTION_FILES = (
...
def main() -> None:
    ...
    ib_endpoint_present = ib_request_fields == (
        "self",
        "reqId",
        "account",
        "modelCode",
    ...
    ctrader_timestamp_window_present = (
        all(
    ...
    ctrader_symbol_schedule_timezone_present = "scheduleTimeZone" in symbol_fields
    ...
    print("ib_reset_timezone_source=ABSENT_FROM_REQPNL_REQUEST_AND_PNL_CALLBACK")
    ...
    print("ctrader_period_start_derivable=" f"{ctrader_period_start_derivable}")
    ...
    print("replay_matches_broker_day_contract=" f"{replay_matches_broker_day_contract}")
