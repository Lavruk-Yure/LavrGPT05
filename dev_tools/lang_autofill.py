...
def translate_with_two_keys(
    ...
    *,
    ...
    try:
        return tr1.translate(text, target_lang, context=context)
    except Exception as e:  # noqa: BLE001
        log_cp(
            log_path,
            "deepl.fail",
    ...
    try:
        return tr2.translate(text, target_lang, context=context)
    except Exception as e:  # noqa: BLE001
        log_cp(
            log_path,
            "deepl.fail",
...
def main() -> int:
    ...
    for key, entry in fallback.items():
        ...
        override = translation_override_for_key(key, target_lang)
