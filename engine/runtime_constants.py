...
WORKSPACE_MACD_EXTREMUM_MIN_PROMINENCE_KEY = "macd_extremum_min_prominence"
...
NEW_WORKSPACE_MACD_EXTREMUM_TO_CROSS_MIN_DISTANCE = (
    NEW_WORKSPACE_MACD_EXTREMUM_TO_CROSS_MIN_DISTANCE_PIPS * FOREX_STANDARD_PIP_SIZE
)
...
DEFAULT_WORKSPACE_PROFIT_DRAWDOWN_CLOSE_PERCENT = 35.0
