...
class Ui_LicenseRequestDialog(object):
    def setupUi(self, LicenseRequestDialog):
        if not LicenseRequestDialog.objectName():
            LicenseRequestDialog.setObjectName(u"LicenseRequestDialog")
        ...
        LicenseRequestDialog.setStyleSheet(u"background-color: #245e6d;")
        ...
        sizePolicy.setHeightForWidth(self.lblEditionTitle.sizePolicy().hasHeightForWidth())
        ...
        self.comboEdition.setObjectName(u"comboEdition")
        ...
        self.lblPriceTitle.setObjectName(u"lblPriceTitle")
        ...
        self.lblHeader.setStyleSheet(u"color: rgb(208, 230, 235);")
        ...
        self.chkConsent.setObjectName(u"chkConsent")
        ...
        self.btnCopyEmail.setObjectName(u"btnCopyEmail")
    ...
    def retranslateUi(self, LicenseRequestDialog):
        LicenseRequestDialog.setWindowTitle(QCoreApplication.translate("LicenseRequestDialog", u"[LicenseRequestDialog.windowTitle]", None))
        self.lblEmailTitle.setText(QCoreApplication.translate("LicenseRequestDialog", u"[LicenseRequestDialog.lblEmailTitle]", None))
        self.lblPriceValue.setText(QCoreApplication.translate("LicenseRequestDialog", u"-", None))
        self.lblEditionTitle.setText(QCoreApplication.translate("LicenseRequestDialog", u"[LicenseRequestDialog.lblEditionTitle]", None))
        self.lblPriceTitle.setText(QCoreApplication.translate("LicenseRequestDialog", u"[LicenseRequestDialog.lblPriceTitle]", None))
        self.lblHeader.setText(QCoreApplication.translate("LicenseRequestDialog", u"[LicenseRequestDialog.lblHeader]", None))
        self.chkConsent.setText(QCoreApplication.translate("LicenseRequestDialog", u"[LicenseRequestDialog.chkConsent]", None))
        self.lblStatus.setText(QCoreApplication.translate("LicenseRequestDialog", u"-", None))
        self.btnGenerate.setText(QCoreApplication.translate("LicenseRequestDialog", u"[LicenseRequestDialog.btnGenerate]", None))
        self.btnCopyEmail.setText(QCoreApplication.translate("LicenseRequestDialog", u"[LicenseRequestDialog.btnCopyEmail]", None))
        self.btnSendEmail.setText(QCoreApplication.translate("LicenseRequestDialog", u"[LicenseRequestDialog.btnSendEmail]", None))
        self.btnClose.setText(QCoreApplication.translate("LicenseRequestDialog", u"[LicenseRequestDialog.btnClose]", None))
    # retranslateUi
