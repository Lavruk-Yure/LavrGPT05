...
class Ui_AlgorithmWorkspaceCreateDialog(object):
    def setupUi(self, AlgorithmWorkspaceCreateDialog):
        if not AlgorithmWorkspaceCreateDialog.objectName():
            AlgorithmWorkspaceCreateDialog.setObjectName(
                "AlgorithmWorkspaceCreateDialog"
            )
        ...
        self.formLayout.setWidget(
            0, QFormLayout.ItemRole.LabelRole, self.lblDisplayName
        )

        self.edtDisplayName = QLineEdit(AlgorithmWorkspaceCreateDialog)
        self.edtDisplayName.setObjectName("edtDisplayName")

        self.formLayout.setWidget(
            0, QFormLayout.ItemRole.FieldRole, self.edtDisplayName
        )
        ...
        self.cmbBroker.setObjectName("cmbBroker")
        ...
        self.accountRow.setObjectName("accountRow")
        self.horizontalLayoutAccount = QHBoxLayout(self.accountRow)
        self.horizontalLayoutAccount.setObjectName("horizontalLayoutAccount")
        ...
        self.lblAccountModeValue.setObjectName("lblAccountModeValue")
        ...
        self.cmbTimeframe.setObjectName("cmbTimeframe")
        ...
        self.lblDataMode.setObjectName("lblDataMode")
        ...
        self.lblControlMode.setObjectName("lblControlMode")

        self.formLayout.setWidget(
            7, QFormLayout.ItemRole.LabelRole, self.lblControlMode
        )
        ...
        self.formLayout.setWidget(
            7, QFormLayout.ItemRole.FieldRole, self.cmbControlMode
        )
        ...
        self.lblNote.setStyleSheet("color: #b7d6dc;\n" "padding-top: 8px;")
        self.lblNote.setWordWrap(True)

        self.verticalLayout.addWidget(self.lblNote)

        self.verticalSpacer = QSpacerItem(
            20, 18, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding
        )
    ...
    def retranslateUi(self, AlgorithmWorkspaceCreateDialog):
        AlgorithmWorkspaceCreateDialog.setWindowTitle(
            QCoreApplication.translate(
                "AlgorithmWorkspaceCreateDialog",
                "[AlgorithmWorkspaceCreateDialog.windowTitle]",
                None,
            )
        )
        self.lblDisplayName.setText(
            QCoreApplication.translate(
                "AlgorithmWorkspaceCreateDialog",
                "[AlgorithmWorkspaceCreateDialog.lblDisplayName]",
                None,
            )
        )
        self.edtDisplayName.setPlaceholderText(
            QCoreApplication.translate(
                "AlgorithmWorkspaceCreateDialog",
        ...
        self.lblBroker.setText(
            QCoreApplication.translate(
                "AlgorithmWorkspaceCreateDialog",
                "[AlgorithmWorkspaceCreateDialog.lblBroker]",
                None,
            )
        )
        self.lblAccount.setText(
            QCoreApplication.translate(
                "AlgorithmWorkspaceCreateDialog",
                "[AlgorithmWorkspaceCreateDialog.lblAccount]",
                None,
            )
        )
        self.lblAccountMode.setText(
            QCoreApplication.translate(
                "AlgorithmWorkspaceCreateDialog",
                "[AlgorithmWorkspaceCreateDialog.lblAccountMode]",
                None,
            )
        )
        self.lblAccountModeValue.setText(
            QCoreApplication.translate("AlgorithmWorkspaceCreateDialog", "\u2014", None)
        )
        self.lblSymbol.setText(
            QCoreApplication.translate(
                "AlgorithmWorkspaceCreateDialog",
                "[AlgorithmWorkspaceCreateDialog.lblSymbol]",
                None,
            )
        )
        self.lblTimeframe.setText(
            QCoreApplication.translate(
                "AlgorithmWorkspaceCreateDialog",
                "[AlgorithmWorkspaceCreateDialog.lblTimeframe]",
                None,
            )
        )
        self.lblAlgorithm.setText(
            QCoreApplication.translate(
                "AlgorithmWorkspaceCreateDialog",
                "[AlgorithmWorkspaceCreateDialog.lblAlgorithm]",
                None,
            )
        )
        self.lblDataMode.setText(
            QCoreApplication.translate(
                "AlgorithmWorkspaceCreateDialog",
                "[AlgorithmWorkspaceCreateDialog.lblDataMode]",
                None,
            )
        )
        self.lblControlMode.setText(
            QCoreApplication.translate(
                "AlgorithmWorkspaceCreateDialog",
                "[AlgorithmWorkspaceCreateDialog.lblControlMode]",
                None,
            )
        )
        ...
        self.btnCreate.setText(
            QCoreApplication.translate(
                "AlgorithmWorkspaceCreateDialog",
                "[AlgorithmWorkspaceCreateDialog.btnCreate]",
                None,
            )
        )
        self.btnCancel.setText(
            QCoreApplication.translate(
                "AlgorithmWorkspaceCreateDialog",
                "[AlgorithmWorkspaceCreateDialog.btnCancel]",
                None,
            )
        )
