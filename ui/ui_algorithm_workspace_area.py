...
from PySide6.QtWidgets import (QApplication, QHBoxLayout, QLabel, QMdiArea,
...
class Ui_AlgorithmWorkspaceArea(object):
    def setupUi(self, AlgorithmWorkspaceArea):
        if not AlgorithmWorkspaceArea.objectName():
            AlgorithmWorkspaceArea.setObjectName(u"AlgorithmWorkspaceArea")
        ...
        self.horizontalLayoutToolbar.setObjectName(u"horizontalLayoutToolbar")
        self.lblTitle = QLabel(AlgorithmWorkspaceArea)
        self.lblTitle.setObjectName(u"lblTitle")
        self.lblTitle.setStyleSheet(u"font: 700 15pt \"Segoe UI\";\n"
"color: #ffffff;")

        self.horizontalLayoutToolbar.addWidget(self.lblTitle)

        self.horizontalSpacerToolbar = QSpacerItem(40, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)
...
"}")
        ...
        self.btnWorkspaceLock.setObjectName(u"btnWorkspaceLock")
        ...
        self.btnWorkspaceLock.setStyleSheet(u"QToolButton#btnWorkspaceLock {\n"
...
"}")
        icon = QIcon()
        icon.addFile(u":/icons/lock_open.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.stackWorkspaceState.setObjectName(u"stackWorkspaceState")
        self.pageEmpty = QWidget()
        self.pageEmpty.setObjectName(u"pageEmpty")
        self.verticalLayoutEmpty = QVBoxLayout(self.pageEmpty)
        self.verticalLayoutEmpty.setObjectName(u"verticalLayoutEmpty")
        self.verticalSpacerEmptyTop = QSpacerItem(20, 40, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding)

        self.verticalLayoutEmpty.addItem(self.verticalSpacerEmptyTop)

        self.lblEmpty = QLabel(self.pageEmpty)
        self.lblEmpty.setObjectName(u"lblEmpty")
        self.lblEmpty.setStyleSheet(u"color: #a7cbd2;\n"
"font: 600 12pt \"Segoe UI\";")
        self.lblEmpty.setAlignment(Qt.AlignmentFlag.AlignCenter)

        self.verticalLayoutEmpty.addWidget(self.lblEmpty)

        self.verticalSpacerEmptyBottom = QSpacerItem(20, 40, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding)
        ...
        self.pageMdi.setObjectName(u"pageMdi")
        self.verticalLayoutMdi = QVBoxLayout(self.pageMdi)
        self.verticalLayoutMdi.setObjectName(u"verticalLayoutMdi")
        self.verticalLayoutMdi.setContentsMargins(0, 0, 0, 0)
        self.mdiWorkspaces = QMdiArea(self.pageMdi)
        self.mdiWorkspaces.setObjectName(u"mdiWorkspaces")
        self.mdiWorkspaces.setStyleSheet(u"QMdiArea#mdiWorkspaces {\n"
"    background-color: #132c35;\n"
"    border: 1px solid #315965;\n"
"    border-radius: 6px;\n"
"}")
        self.mdiWorkspaces.setVerticalScrollBarPolicy(Qt.ScrollBarPolicy.ScrollBarAsNeeded)
        self.mdiWorkspaces.setHorizontalScrollBarPolicy(Qt.ScrollBarPolicy.ScrollBarAsNeeded)
        self.mdiWorkspaces.setActivationOrder(QMdiArea.WindowOrder.ActivationHistoryOrder)
    ...
    def retranslateUi(self, AlgorithmWorkspaceArea):
        self.lblTitle.setText(QCoreApplication.translate("AlgorithmWorkspaceArea", u"[AlgorithmWorkspaceArea.lblTitle]", None))
        self.btnNew.setText(QCoreApplication.translate("AlgorithmWorkspaceArea", u"[AlgorithmWorkspaceArea.btnNew]", None))
        self.btnCascade.setText(QCoreApplication.translate("AlgorithmWorkspaceArea", u"[AlgorithmWorkspaceArea.btnCascade]", None))
        self.btnTile.setText(QCoreApplication.translate("AlgorithmWorkspaceArea", u"[AlgorithmWorkspaceArea.btnTile]", None))
        self.lblEmpty.setText(QCoreApplication.translate("AlgorithmWorkspaceArea", u"[AlgorithmWorkspaceArea.lblEmpty]", None))
        pass
    # retranslateUi
