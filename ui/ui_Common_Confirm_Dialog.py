...
class Ui_CommonConfirmDialog(object):
    def setupUi(self, CommonConfirmDialog):
        if not CommonConfirmDialog.objectName():
            CommonConfirmDialog.setObjectName(u"CommonConfirmDialog")
        ...
        self.lblDetails.setTextInteractionFlags(Qt.TextInteractionFlag.TextSelectableByMouse)
    ...
    def retranslateUi(self, CommonConfirmDialog):
        CommonConfirmDialog.setWindowTitle(QCoreApplication.translate("CommonConfirmDialog", u"\"CommonConfirmDialog.windowTitle\"", None))
        self.lblIcon.setText(QCoreApplication.translate("CommonConfirmDialog", u"?", None))
        self.lblHeader.setText(QCoreApplication.translate("CommonConfirmDialog", u"[CommonConfirmDialog.lblHeader]", None))
        self.lblDetails.setText(QCoreApplication.translate("CommonConfirmDialog", u"[CommonConfirmDialog.lblDetails]", None))
        self.btnYes.setText(QCoreApplication.translate("CommonConfirmDialog", u"[CommonConfirmDialog.btnYes]", None))
        self.btnNo.setText(QCoreApplication.translate("CommonConfirmDialog", u"[CommonConfirmDialog.btnNo]", None))
    # retranslateUi
