...
class Ui_MainAppWindow(object):
    def setupUi(self, MainAppWindow):
        ...
        self.lblMarketState.setObjectName("lblMarketState")
        self.lblMarketState.setStyleSheet(
            "QLabel {\n"
            "    color: #ffffff;\n"
    ...
    def retranslateUi(self, MainAppWindow):
        MainAppWindow.setWindowTitle(
            QCoreApplication.translate(
                "MainAppWindow", "[MainAppWindow.windowTitle]", None
            )
        )
        self.lblMarketState.setText(
            QCoreApplication.translate(
                "MainAppWindow", "[MainAppWindow.statusForexMarketClosed]", None
            )
        )
        self.toolBarMain.setWindowTitle(
            QCoreApplication.translate("MainAppWindow", "toolBar", None)
        )
