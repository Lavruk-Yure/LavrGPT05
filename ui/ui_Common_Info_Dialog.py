...
class Ui_CommonInfoDialog(object):
    def setupUi(self, CommonInfoDialog):
        if not CommonInfoDialog.objectName():
            CommonInfoDialog.setObjectName(u"CommonInfoDialog")
    ...
    def retranslateUi(self, CommonInfoDialog):
        CommonInfoDialog.setWindowTitle(QCoreApplication.translate("CommonInfoDialog", u"[CommonInfoDialog.windowTitle]", None))
        self.lblIcon.setText(QCoreApplication.translate("CommonInfoDialog", u"I", None))
        self.lblHeader.setText(QCoreApplication.translate("CommonInfoDialog", u"[CommonInfoDialog.lblHeader]", None))
        self.lblDetails.setText(QCoreApplication.translate("CommonInfoDialog", u"[CommonInfoDialog.lblDetails]", None))
        self.btnOk.setText(QCoreApplication.translate("CommonInfoDialog", u"[CommonInfoDialog.btnOk]", None))
    # retranslateUi
