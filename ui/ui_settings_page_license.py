...
class Ui_pageLicense(object):
    def setupUi(self, pageLicense):
        ...
        sizePolicy1.setHeightForWidth(self.editLicenseKey.sizePolicy().hasHeightForWidth())
        self.editLicenseKey.setSizePolicy(sizePolicy1)
        self.editLicenseKey.setMinimumSize(QSize(70, 160))
        self.editLicenseKey.setVerticalScrollBarPolicy(Qt.ScrollBarPolicy.ScrollBarAsNeeded)
        self.editLicenseKey.setHorizontalScrollBarPolicy(Qt.ScrollBarPolicy.ScrollBarAsNeeded)
        ...
        self.btnGetLicense.setObjectName(u"btnGetLicense")
    ...
    def retranslateUi(self, pageLicense):
        ...
        self.btnGetLicense.setText(QCoreApplication.translate("pageLicense", u"[SettingsPageLicense.btnGetLicense]", None))
