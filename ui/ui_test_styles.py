...
class Ui_LGEStyleTester(object):
    def setupUi(self, LGEStyleTester):
        if not LGEStyleTester.objectName():
            LGEStyleTester.setObjectName(u"LGEStyleTester")
        LGEStyleTester.resize(800, 500)
        LGEStyleTester.setStyleSheet(u"\n"
...
"}")
    ...
    def retranslateUi(self, LGEStyleTester):
        LGEStyleTester.setWindowTitle(QCoreApplication.translate("LGEStyleTester", u"LGE Style Tester", None))
        self.lblTitle.setText(QCoreApplication.translate("LGEStyleTester", u"LGE Style Test", None))
        self.editSample.setPlaceholderText(QCoreApplication.translate("LGEStyleTester", u"Type something...", None))
        self.btnTest.setText(QCoreApplication.translate("LGEStyleTester", u"Test Button", None))
        self.comboSample.setItemText(0, QCoreApplication.translate("LGEStyleTester", u"Option 1", None))
        self.comboSample.setItemText(1, QCoreApplication.translate("LGEStyleTester", u"Option 2", None))
