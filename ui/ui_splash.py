...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayout.addWidget(
            self.progressBar, 0, Qt.AlignmentFlag.AlignHCenter
        )
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(
            QCoreApplication.translate("MainWindow", "[SplashWindow.windowTitle]", None)
        )
        self.lblTitle.setText(
            QCoreApplication.translate("MainWindow", "[SplashWindow.lblTitle]", None)
        )
        self.lblStatus.setText(
            QCoreApplication.translate("MainWindow", "[SplashWindow.lblStatus]", None)
        )
