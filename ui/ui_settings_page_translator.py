...
class Ui_pageTranslator(object):
    def setupUi(self, pageTranslator):
        ...
        sizePolicy2.setHeightForWidth(self.comboProvider.sizePolicy().hasHeightForWidth())
...
"")
        ...
        self.lblDeeplHelp.setObjectName(u"lblDeeplHelp")
        sizePolicy3 = QSizePolicy(QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Minimum)
        sizePolicy3.setHorizontalStretch(0)
        sizePolicy3.setVerticalStretch(0)
        sizePolicy3.setHeightForWidth(self.lblDeeplHelp.sizePolicy().hasHeightForWidth())
        ...
        self.lblDeeplHelp.setAlignment(Qt.AlignmentFlag.AlignLeading|Qt.AlignmentFlag.AlignLeft|Qt.AlignmentFlag.AlignTop)
    ...
    def retranslateUi(self, pageTranslator):
        ...
        self.lblDeeplHelp.setText(QCoreApplication.translate("pageTranslator", u"[SettingsPageTranslator.lblDeeplHelp]", None))
