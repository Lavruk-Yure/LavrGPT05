...
class Ui_LicenseOverwriteDialog(object):
    def setupUi(self, LicenseOverwriteDialog):
        if not LicenseOverwriteDialog.objectName():
            LicenseOverwriteDialog.setObjectName(u"LicenseOverwriteDialog")
        ...
        LicenseOverwriteDialog.setStyleSheet(u"background-color: rgb(36, 94, 109);")
        ...
        self.chkAlsoDeletePayment.setObjectName(u"chkAlsoDeletePayment")
        ...
        self.btnOverwrite.setObjectName(u"btnOverwrite")
    ...
    def retranslateUi(self, LicenseOverwriteDialog):
        LicenseOverwriteDialog.setWindowTitle(QCoreApplication.translate("LicenseOverwriteDialog", u"[LicenseOverwriteDialog.windowTitle]", None))
        self.lblHeader.setText(QCoreApplication.translate("LicenseOverwriteDialog", u"[LicenseOverwriteDialog.lblHeader]", None))
        self.lblDetails.setText(QCoreApplication.translate("LicenseOverwriteDialog", u"[LicenseOverwriteDialog.lblDetails]", None))
        self.chkAlsoDeletePayment.setText(QCoreApplication.translate("LicenseOverwriteDialog", u"[LicenseOverwriteDialog.chkAlsoDeletePayment]", None))
        self.btnOverwrite.setText(QCoreApplication.translate("LicenseOverwriteDialog", u"[LicenseOverwriteDialog.btnOverwrite]", None))
        self.btnCancel.setText(QCoreApplication.translate("LicenseOverwriteDialog", u"[LicenseOverwriteDialog.btnCancel]", None))
    # retranslateUi
