...
class Ui_AlgorithmWorkspaceCard(object):
    def setupUi(self, AlgorithmWorkspaceCard):
        if not AlgorithmWorkspaceCard.objectName():
            AlgorithmWorkspaceCard.setObjectName("AlgorithmWorkspaceCard")
        ...
        self.lblName.setStyleSheet('font: 700 14pt "Segoe UI";\n' "color: #ffffff;")
        ...
        self.formLayout.setWidget(
            0, QFormLayout.ItemRole.LabelRole, self.lblBrokerCaption
        )
        ...
        self.formLayout.setWidget(
            1, QFormLayout.ItemRole.LabelRole, self.lblAccountCaption
        )
        ...
        self.formLayout.setWidget(
            2, QFormLayout.ItemRole.LabelRole, self.lblSymbolCaption
        )
        ...
        self.formLayout.setWidget(
            3, QFormLayout.ItemRole.LabelRole, self.lblTimeframeCaption
        )
        ...
        self.formLayout.setWidget(
            4, QFormLayout.ItemRole.LabelRole, self.lblAlgorithmCaption
        )
        ...
        self.lblUidCaption.setObjectName("lblUidCaption")
        ...
        self.lblUid.setStyleSheet("color: #a7cbd2;")
        self.lblUid.setTextInteractionFlags(
    ...
    def retranslateUi(self, AlgorithmWorkspaceCard):
        self.lblName.setText(
            QCoreApplication.translate("AlgorithmWorkspaceCard", "Workspace", None)
        )
        self.lblState.setText(
            QCoreApplication.translate("AlgorithmWorkspaceCard", "STOPPED", None)
        )
        self.btnRename.setText(
            QCoreApplication.translate(
                "AlgorithmWorkspaceCard", "[AlgorithmWorkspaceCard.btnRename]", None
            )
        )
        self.lblBrokerCaption.setText(
            QCoreApplication.translate(
                "AlgorithmWorkspaceCard", "[AlgorithmWorkspaceCard.lblBroker]", None
            )
        )
        self.lblBroker.setText(
            QCoreApplication.translate("AlgorithmWorkspaceCard", "\u2014", None)
        )
        self.lblAccountCaption.setText(
            QCoreApplication.translate(
                "AlgorithmWorkspaceCard", "[AlgorithmWorkspaceCard.lblAccount]", None
            )
        )
        ...
        self.lblSymbolCaption.setText(
            QCoreApplication.translate(
                "AlgorithmWorkspaceCard", "[AlgorithmWorkspaceCard.lblSymbol]", None
            )
        )
        ...
        self.lblTimeframeCaption.setText(
            QCoreApplication.translate(
                "AlgorithmWorkspaceCard", "[AlgorithmWorkspaceCard.lblTimeframe]", None
            )
        )
        ...
        self.lblAlgorithmCaption.setText(
            QCoreApplication.translate(
                "AlgorithmWorkspaceCard", "[AlgorithmWorkspaceCard.lblAlgorithm]", None
            )
        )
        self.lblAlgorithm.setText(
            QCoreApplication.translate("AlgorithmWorkspaceCard", "\u2014", None)
        )
        self.lblUidCaption.setText(
            QCoreApplication.translate(
                "AlgorithmWorkspaceCard", "[AlgorithmWorkspaceCard.lblUid]", None
            )
        )
        self.lblUid.setText(
            QCoreApplication.translate("AlgorithmWorkspaceCard", "\u2014", None)
